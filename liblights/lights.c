...
char const*const LCD_AUTO_FILE      = "/sys/class/leds/lcd-backlight";

char const*const CAMERA2_LED_FILE   = "/sys/class/leds/green-camera/brightness";
...
const struct hw_module_t HAL_MODULE_INFO_SYM = {
	...
	.author = "Esa Laukkanen <ele.linux@gmail.com>",
